...
const AuthPage: React.FC<AuthProps> = ({ initialView = "login" }) => {
  ...
  return (
    <div className="min-h-[100svh] w-full grid lg:grid-cols-2 bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      {/* ================= LEFT: VISUAL (Desktop) ================= */}
      <div className="hidden lg:flex relative overflow-hidden bg-slate-900 flex-col justify-between p-12 text-white">
        ...
        <div className="relative z-10">
          ...
          <p className="text-2xl font-medium leading-relaxed mb-4">
            "Lumina transformed how we deploy enterprise architecture. It's not just a tool,
              ...
              >
                ...
                <div className="mt-12 pt-8 border-t border-slate-100 dark:border-slate-800 flex items-center justify-center gap-6 grayscale opacity-60">
                  <div className="flex items-center gap-1 font-bold text-slate-500 text-xs">
                    <Command size={14} /> ACME Corp
                  </div>
                  <div className="w-1 h-1 rounded-full bg-slate-300" />
                  <div className="flex items-center gap-1 font-bold text-slate-500 text-xs">
                    <Command size={14} /> Stark Ind
                  </div>
                </div>
              </motion.div>
            )}
